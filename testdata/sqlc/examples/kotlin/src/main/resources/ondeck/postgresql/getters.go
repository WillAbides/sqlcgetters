...
func (x Venue) GetStatus() Status {
	return x.Status
}

func (x Venue) GetStatuses() []Status {
	return x.Statuses
}
...
func (x CreateVenueParams) GetStatus() Status {
	return x.Status
}

func (x CreateVenueParams) GetStatuses() []Status {
	return x.Statuses
}

func (x CreateVenueParams) GetTags() []string {
	return x.Tags
}
