...
func (x DtNetType) GetA() pgtype.Inet {
	return x.A
}

func (x DtNetType) GetB() pgtype.CIDR {
	return x.B
}

func (x DtNetType) GetC() pgtype.Macaddr {
	return x.C
}

func (x DtNetTypesNotNull) GetA() pgtype.Inet {
	return x.A
}

func (x DtNetTypesNotNull) GetB() pgtype.CIDR {
	return x.B
}

func (x DtNetTypesNotNull) GetC() pgtype.Macaddr {
	return x.C
}
...
func (x DtNumeric) GetD() pgtype.Numeric {
	return x.D
}

func (x DtNumeric) GetE() pgtype.Numeric {
	return x.E
}
...
func (x DtNumericNotNull) GetD() pgtype.Numeric {
	return x.D
}

func (x DtNumericNotNull) GetE() pgtype.Numeric {
	return x.E
}
...
func (x DtRange) GetA() pgtype.Int4range {
	return x.A
}

func (x DtRange) GetB() pgtype.Int8range {
	return x.B
}

func (x DtRange) GetC() pgtype.Numrange {
	return x.C
}

func (x DtRange) GetD() pgtype.Tsrange {
	return x.D
}

func (x DtRange) GetE() pgtype.Tstzrange {
	return x.E
}

func (x DtRange) GetF() pgtype.Daterange {
	return x.F
}

func (x DtRangeNotNull) GetA() pgtype.Int4range {
	return x.A
}

func (x DtRangeNotNull) GetB() pgtype.Int8range {
	return x.B
}

func (x DtRangeNotNull) GetC() pgtype.Numrange {
	return x.C
}

func (x DtRangeNotNull) GetD() pgtype.Tsrange {
	return x.D
}

func (x DtRangeNotNull) GetE() pgtype.Tstzrange {
	return x.E
}

func (x DtRangeNotNull) GetF() pgtype.Daterange {
	return x.F
}
