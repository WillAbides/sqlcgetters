...
func (x UpdateCodeParams) GetCreatedBy() string {
	return x.CreatedBy
}

func (x UpdateCodeParams) GetCode() sql.NullString {
	return x.Code
}

func (x UpdateCodeParams) GetHash() sql.NullString {
	return x.Hash
}

func (x UpdateCodeParams) GetTestID() int32 {
	return x.TestID
}

func (x UpdateCodeRow) GetHash() sql.NullString {
	return x.Hash
}

func (x UpdateCodeRow) GetID() int32 {
	return x.ID
}

func (x UpdateCodeRow) GetTsCreated() time.Time {
	return x.TsCreated
}

func (x UpdateCodeRow) GetTsUpdated() time.Time {
	return x.TsUpdated
}

func (x UpdateCodeRow) GetCreatedBy() string {
	return x.CreatedBy
}

func (x UpdateCodeRow) GetUpdatedBy() string {
	return x.UpdatedBy
}

func (x UpdateCodeRow) GetTestID() int32 {
	return x.TestID
}

func (x UpdateCodeRow) GetCodeHash() string {
	return x.CodeHash
}
